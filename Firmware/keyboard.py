...
from kmk.modules.layers import Layerss
import board
...
keyboard.keymap = [
    [
        KC.ESC, KC.F1, KC.F2, KC.F3, KC.F4, KC.F5, KC.F6, KC.F7, KC.F8, KC.F9, KC.F10, KC.F11, KC.F12, KC.PSCR, KC.PAUSE, KC.DEL,
        ...
        KC.LCTL, KC.LGUI, KC.LALT, KC.SPC, KC.RALT, FN, KC.RCTL, KC.LEFT, KC.DOWN, KC.RIGHT
    ],
    [
